...
var ES6 = assign(assign({}, es5), {
	...
	IsConcatSpreadable: function IsConcatSpreadable(O) {
		...
		if (hasSymbols$1 && typeof Symbol.isConcatSpreadable === 'symbol') {
	...
	ArraySpeciesCreate: function ArraySpeciesCreate(originalArray, length) {
		...
		if (isArray) {
			...
			// }
			if (this.Type(C) === 'Object' && hasSymbols$1 && Symbol.species) {
...
var implementation = function entries(O) {
...
var object_assign$1 = polyfill$3;
...
var reduce$2 = Function.call.bind(Array.prototype.reduce);
...
var implementation$9 = function getOwnPropertyDescriptors(value) {
	...
	return reduce$2(getAll(O), function (acc, key) {
...
var polyfill$6 = function getPolyfill() {
	return typeof Object.getOwnPropertyDescriptors === 'function' ? Object.getOwnPropertyDescriptors : implementation$9;
};
...
var shim$6 = function shimGetOwnPropertyDescriptors() {
...
defineProperties_1(implementation$9, {
	getPolyfill: polyfill$6,
	implementation: implementation$9,
	shim: shim$6
});

var object_getownpropertydescriptors$1 = implementation$9;
...
var filter$1 = Function.call.bind(Array.prototype.filter);

var reduce$1 = Function.call.bind(Array.prototype.reduce);
...
var toProperty = function (ref) {
  ...
  var property = object_assign$1({}, descriptor, { name: name });
  return property;
};

var getProperties = function (object) {
  var descriptors = object_getownpropertydescriptors$1(object);
  var properties = map(object_entries$1(descriptors), toProperty);
  return properties;
};
...
var withMethod = function (object, ref) {
  ...
  var result = object_assign$1({}, object, ( obj = {}, obj[name] = Function.call.bind(value), obj));
  return result;
};

var uncouple = function (object) {
  var properties = getProperties(object.prototype || object);
  var methods = filter$1(properties, isMethod);
  var uncoupled = reduce$1(methods, withMethod, {});
  return uncoupled;
};
...
var reduce$3 = ref$3.reduceRight;
...
var compose = function () {
  ...
  var composition = function (value) { return reduce$3(λs, function (value, λ) { return λ(value); }, value); };
  return composition
};
...
var replace$1 = ref$1$1.replace;
var trim$1 = ref$1$1.trim;
 ...
 * @returns {string}
 */
var whitespaces = function (value) { return replace$1(value, /\s{2,}/g, ' '); };
...
var diacritics = compose(
  function (value) { return replace$1(value, /[\u0080-\uF8FF]/g, ''); },
 ...
 * @returns {string}
 */
var normalizeText = compose(lower, whitespaces, trim$1, diacritics, merge);
